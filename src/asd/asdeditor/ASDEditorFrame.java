...
class ASDEditorFrame extends JFrame //implements PropertyChangeListener
{
...
public int showVerificationDetail(JSplitPane splitPane) {
  repaint();
     splitPane.setDividerLocation(
    (int) (splitPane.getHeight() - 
     splitPane.getDividerSize() -
     splitPane.getBottomComponent().getHeight())
    );
  mainSplitPane.setDividerLocation(mainSplitPane.getDividerLocation()  );
    //System.out.println(mainSplitPane.getDividerLocation());
    System.out.println ("    The mainXSplit divider location is: " 
  ...
  static final int RIGHT_DIVIDER_LOCATION = 450;
   ...
   private static JSplitPane topLeftSplitPane;// inner inner horizontal
   private JSplitPane topMiddleSplitPane;// inner inner inner vertical
   private JSplitPane topSplitPane;// inner horizontal top
   private static JSplitPane mainSplitPane;// outer split pane ( vertical)
